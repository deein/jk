<!-- ESWC -->
<div class="slider"><img src="images/portfolio/aaclabel.jpg" title="Aesthetic Art Clinic - D-Partners" /></div>
<div class="opening">
  <div class="timer"></div>
  ...
  <div class="innerCircleOpening">
    <div class="descOpening">
      <h5>Réalisation</h5>
      <hr />
      <h1>Label - Aesthetic Art Clinic</h1>
      <h2>D-Partners</h2>
      <hr />
      <div class="description"> Présentation de l'activité en vidéo. Objectif : Présenter le parcours et les services dédiés à l'utilisateur. </div>
    </div>
    <div class="voir">
...
//html = '<iframe id="player" width="1000" height="593" src="//www.youtube.com/embed/1daZw6Nyc5E?html5=1&rel=0&wmode=Opaque&enablejsapi=1&modestbranding=2&cc_load_policy=0&showinfo=0" frameborder="0" allowfullscreen></iframe>';
